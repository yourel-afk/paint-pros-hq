...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "High-end residential master painters serving 93 Melbourne suburbs from our Mitcham Office. 100% in-house crews. 10-year masterpiece guarantee." },
