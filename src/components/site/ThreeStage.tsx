...
const STAGES = [
  ...
  },
  {
    ...
    desc:
      "Before we pack the van, a senior runs a 100-point check under raking site lighting. The harsh angle exposes every roller mark, every dust nib, every missed cut. Anything that doesn't pass gets fixed on the spot, not on a callback. Then we walk the job with you, room by room, with a torch. You sign off when you're happy. Not before.",
    img: stageHandover,
